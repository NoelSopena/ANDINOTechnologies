		...
		<div class="container">
			...
			<form id="anadirContrato" action="ViewContractUpdate.php" method="post" enctype="multipart/form-data">
				<div class="row">
					...
					<label class="col-md-2 col-md-offset-1"><?php echo $lang['effectiveDateTo']; ?>: <input type="date" class="form-control" id="dateTo" name="dateTo" value=<?php echo $deadline ?>></label>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1">
						...
						<input type="text" class="form-control" placeholder="<?php echo $lang['contName']; ?>" onkeyup="valid(this)" onblur="valid(this)" id="contractorName" name="contractorName" value='<?php echo $contractorName ?>'></div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-3" id="type">
						...
						<!-- This dropdown is to select the type of contract -->
						<div id="txtHint"><select class='form-control' name='type' value=<?php echo $serviceType ?> required><?php echo "<option>" . $serviceType . "</option>" ?></select></div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3 ">
						...
						<input type="text" class="form-control" placeholder="<?php echo $lang['contAmount']; ?>" onkeyup="valid(this)" onblur="valid(this)" id="quantity" name="quantity" value='<?php echo $quantity ?>'>
					</div>

					<div class="col-md-3">
						<label "control-label"><?php echo $lang['fondo']; ?>:</label>
						<input type="text" class="form-control" placeholder="<?php echo $lang['fondo']; ?> " onkeyup="valid(this)" onblur="valid(this)" id="fondo" name="fondo" value='<?php echo $fondo ?>'>
						</div>

					<div class="col-md-3 ">
						<label "control-label"><?php echo $lang['status']; ?>:</label>
						<input type="text" class="form-control" placeholder="<?php echo $lang['status']; ?>" onkeyup="valid(this)" onblur="valid(this)" id="status" name="status" value='<?php echo $status ?>'>
					</div>
				</div>
